    ...
    return ( <
        ...
        /div> {
            type !== "list" && ( <
                ...
                Get rewarded
                for your travels– unlock instant savings of 10 % or more with a free Lamabooking account <
                /p> {!user && < button className = "headerBtn" > Sign in / Register</ > } <
                ...
                { `${options.adult} adult · ${options.children} children · ${options.room} room` } < /span> {
                    openOptions && ( <
                        ...
                        <
                        /button> <
                        span className = "optionCounterNumber" > { options.adult } <
                        /span> <
